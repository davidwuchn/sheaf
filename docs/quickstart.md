...
Download the examples archive from the [releases page](https://github.com/sheaf-lang/sheaf/releases) ([direct link](https://github.com/sheaf-lang/sheaf/releases/download/v2.0.0-rc1/sheaf-examples.tar.gz)). Each example is self-contained:
